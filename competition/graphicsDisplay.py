...
PACMAN_COLOR = formatColor(225.0/255.0,255.0/255.0,61.0/255)
PACMAN_COLOR2 = formatColor(65.0/255.0,255.0/255.0,65.0/255)
PACMAN_SCALE = 0.5
#pacman_speed = 0.25
...
class InfoPane:
    ...
    def drawPane(self):
        self.score0Text = text( self.toScreen(0, 0  ), self.textColor, "SCORE0:    0", "Times", self.fontSize, "bold") 
        self.score1Text =  text( self.toScreen(600, 0  ), PACMAN_COLOR2, "SCORE1:    0", "Times", self.fontSize, "bold")
    ...
    # self.scoreText will display both scores
    def updateScores(self, score0, score1):
        changeText(self.score0Text, "SCORE0: % 4d" % score0)
        changeText(self.score1Text, "SCORE1: % 4d" % score1)
...
class PacmanGraphics:
    ...
    def update(self, newState):
        ...
        self.infoPane.updateScores(newState.score0, newState.score1)
